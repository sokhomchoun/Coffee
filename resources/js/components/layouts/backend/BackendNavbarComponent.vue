            ...
            <div
                ...
                <div class="flex items-center justify-between md:justify-center gap-4">
                    <div v-if="setting.site_language_switch === enums.activityEnum.ENABLE"
                        ...
                        <button class="dropdown-btn flex items-center gap-2 h-9 px-3 rounded-lg bg-[#D8FFFC]">
            ...
            <div class="dropdown-group">
                ...
                <div
                    ...
                    <div class="w-fit mx-auto text-center mb-5">
                        <figure
                            class="relative z-10 w-[98px] h-[98px] border-2 border-dashed rounded-full inline-flex items-center justify-center border-white bg-gradient-to-t from-[#FF7A00] to-[#00B3A5] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-24 before:h-24 before:rounded-full before:-z-10 before:bg-white">
                        ...
                        <p class="text-xs" dir="ltr">{{ authInfo.country_code }}{{ authInfo.phone }}</p>
