        ...
        <div class="container">
            ...
            <div v-if="categories.length > 0" class="flex flex-wrap gap-3 w-full mb-6 sm:mb-12 veg-navs">
                <button :disabled="itemProps.type !== null && itemProps.type === itemTypeEnum.VEG"
                    ...
                    <span class="capitalize text-xs sm:text-sm font-medium text-heading">{{ $t('label.frontend_non_veg') }}</span>
                    <i class="lab-close-circle-line text-lg sm:text-xl text-red-500 transition opacity-0 ltr:-ml-8 rtl:-mr-8 clear-item-type-filter font-fill-danger"></i>
                </button>
                <button :disabled="itemProps.type !== null && itemProps.type === itemTypeEnum.NON_VEG"
                    ...
                    <i class="lab-close-circle-line text-lg sm:text-xl text-red-500 transition opacity-0 ltr:-ml-8 rtl:-mr-8 font-fill-danger"></i>
                </button>
            </div>
