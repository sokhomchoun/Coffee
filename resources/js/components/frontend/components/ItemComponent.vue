        ...
        <div v-for="item in items" :key="item" v-show="type === null || type === item.item_type" class="product-card-grid">
            ...
            <div class="product-card-grid-content-group">
                <div class="product-card-grid-header-group">
                    ...
                    <button type="button" class="product-card-grid-info-btn info-btn leading-none" data-modal="#item-info-modal"
                        @click.prevent="infoModalShow(item.name, item.caution)">
                        <i class="lab lab-information font-fill-paragraph transition lab-font-size-16"></i>
                    </button>
                </div>
                            ...
                            <SwiperSlide v-for="addon in item.addons" :key="addon" class="!w-fit !relative">
                                <div class="swiper-slide">
                                    ...
                                    <div
                                        ...
                                        <button type="button" class="info-btn leading-none" data-modal="#item-info-modal"
