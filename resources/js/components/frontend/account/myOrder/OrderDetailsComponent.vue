                ...
                <div class="w-full">
                    <div class="p-4 mb-6 rounded-2xl shadow-xs bg-white">
                        ...
                        <div class="flex flex-wrap items-center gap-2 mb-5">
                            <span v-if="parseInt(order.order_type) == parseInt(enums.orderTypeEnum.TAKEAWAY)" class="text-sm capitalize">{{ $t("label.takeaway_time") }} :</span>
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between gap-5">
                                ...
                                <div class="flex gap-4"
                                    ...
                                    <router-link class="w-8 h-8 rounded-full flex items-center justify-center bg-[#D8FFFC]"
                        ...
                        <ul class="flex flex-col gap-2 mb-6">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <span class="capitalize text-sm leading-6"
                                    :class="enums.paymentStatusEnum.PAID === order.payment_status ? 'text-green-600' : 'text-danger'">
                ...
                <div class="w-full rounded-2xl shadow-xs bg-white">
                    ...
                    <div class="p-4" v-if="order.status === enums.orderStatusEnum.PENDING">
                        <button @click="changeStatus(enums.orderStatusEnum.CANCELED)"
                            class="w-full rounded-3xl capitalize font-medium leading-6 py-3 text-white bg-danger">
