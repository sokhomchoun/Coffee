...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('variation')->name('variation.')->group(function () {
        ...
        Route::post('/update-variation', [VariationController::class,'update']);
        Route::post('/delete-variation', [VariationController::class, 'destroy']);
    });
    ...
    Route::prefix('brand')->name('brand.')->group(function () {
        ...
        Route::match(['post', 'put', 'patch'], '/{item}', [BrandController::class, 'update']);
        Route::delete('/{item}', [BrandController::class, 'destroy']);
    });
    ...
    Route::prefix('unit')->name('unit.')->group(function () {
        ...
        Route::match(['post', 'put', 'patch'], '/{item}', [UnitController::class, 'update']);
        Route::delete('/{item}', [UnitController::class, 'destroy']);
    });

    // Product API
    Route::prefix('product')->name('product.')->group(function () {
        Route::get('/brand-list', [ProductController::class, 'brandList']);
        Route::get('/product-unit-list', [ProductController::class, 'unitList']);
        Route::get('/branch-list', [ProductController::class, 'branchList']);
        Route::get('/category-list', [ProductController::class, 'categoryList']);
        Route::get('/product-list', [ProductController::class, 'productList']);
        Route::get('/supplier-list', [ProductController::class, 'supplierList']);
        Route::get('/', [ProductController::class, 'index']);
        Route::post('/', [ProductController::class,'store']);
        Route::match(['post', 'put', 'patch'], '/{item}', [ProductController::class, 'update']);
        Route::delete('/{item}', [ProductController::class, 'destroy']);
    });
    ...
    Route::prefix('purchaseOrders')->name('purchaseOrders.')->group(function () {
        ...
        Route::post('/update-purchaseOrders', [PurchaseOrdersController::class,'update']);
        Route::post('/delete-purchaseOrders', [PurchaseOrdersController::class, 'destroy']);
    });

    // Stock Alert API
    Route::prefix('stockalert')->name('stockalert.')->group(function () {
        Route::get('/', [StockAlertController::class, 'index']);
        // Route::get('/stock-alert', [StockAlertController::class,'stockAlert']);
        // Route::post('/', [SupplierController::class,'store']);
        // Route::post('/update-supplier', [SupplierController::class,'update']);
        // Route::post('/delete-supplier', [SupplierController::class, 'destroy']);
    });
